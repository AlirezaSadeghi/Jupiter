...
public class PBltA extends PBranchA
{

	public PBltA (Register rs , Register rt , Immediate immediate )
	{
	...
	public Word[] generateMachineCode(Word address) {
		...
		words[0] = (new RSlt(this.rs, this.rt, at,0)).generateMachineCode(address)[0] ; 
